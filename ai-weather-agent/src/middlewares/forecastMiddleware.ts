...
/**
 * Runs after ForecastQueryDto validation. Ensures startDate is not in the past
 * (forecasts are forward-looking) and endDate >= startDate.
 */
function GetForecastMiddleware(req: Request, res: Response, next: NextFunction): void {
...
export default GetForecastMiddleware;
